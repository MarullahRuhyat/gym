...
class EditSubscriptionController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.edit_subscription.index', compact('results'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.edit_subscription.edit', compact('user', 'membership', 'packages'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin_edit_subscription')->with('success', 'Subscription period updated successfully!');
    }
}
