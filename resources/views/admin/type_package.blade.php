        ...
        <table class="table table-bordered mb-0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <!-- Contoh tombol aksi -->
                        <button class="btn btn-sm btn-primary button_edit" data-bs-toggle="modal" data-bs-target="#modalEdit" data-id="{{$row->id}}" data-name="{{$row->name}}" data-bonus="{{$row->bonus}}" data-max_user="{{$row->max_user}}">Edit</button>
        ...
        <div class="modal-content">
            ...
            <form id="membershipForm" method="POST" action="">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="edit_max_user">Max User</label>
                        <input type="text" class="form-control" id="edit_max_user" name="max_user" required>
                    </div>
                    <div class="form-group">
