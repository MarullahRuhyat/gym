...
Route::prefix('member')->group(function () {
    ...
    Route::get('/forgot-password', [MemberAuthController::class, 'forgotPassword'])->name('member.forgot_password');
    Route::post('/forgot-password', [MemberAuthController::class, 'forgotPasswordProcess'])->name('member.forgot_password.process');
    ...
    Route::middleware(Member::class)->group(function () {
        ...
        Route::post('/check_qr_status', [ProfileController::class, 'check_qr_status'])->name('member.check_qr_status');
        ...
        Route::prefix('package')->group(function () {
            ...
            Route::post('/submit-cash-payment-extend', [PackageController::class, 'submitCashExtendPayment'])->name('member.submit-cash-extend-payment');
