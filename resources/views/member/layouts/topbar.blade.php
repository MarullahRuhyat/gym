       ...
       <li class="nav-item dropdown">
         <a href="javascript:void(0);" class="dropdown-toggle dropdown-toggle-nocaret" data-bs-toggle="dropdown">
           <!-- <img src="{{ URL::asset('build/images/member/photo_profile/'.auth()->user()->photo_profile) }}" class="rounded-circle p-1 border" width="45" height="45" alt=""> -->
            <img src="{{ URL::asset('build/images/member/photo_profile/'.(auth()->user()->photo_profile ?? 'default.JPEG')) }}" class="rounded-circle p-1 border" width="45" height="45" alt="">

         </a>
         <div class="dropdown-menu dropdown-user dropdown-menu-end shadow">
           <a class="dropdown-item  gap-2 py-2" href="javascript:;">
             <div class="text-center">
                <img src="{{ URL::asset('build/images/member/photo_profile/'.(auth()->user()->photo_profile ?? 'default.JPEG')) }}" class="rounded-circle p-1 shadow mb-3" width="90" height="90" alt="">
           ...
           <a class="dropdown-item d-flex align-items-center gap-2 py-2" href="{{ route('member.subscribed-package') }}"><i class="material-icons-outlined">account_balance</i>Subscription Packages</a>
