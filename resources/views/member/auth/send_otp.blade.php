                    ...
                    <div class="form-body mt-4">
                        <form class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                {{-- <input type="text" class="form-control" id="inputPhoneNumber" placeholder="Input Your Phone Number" value="{{ $phone_number ?? '' }}"
                                oninput="this.value = this.value.replace(/\+62/, '0').replace(/[^0-9]/g, '');"> --}}
                            </div>
                            <div class="col-12">
                                <div class="d-grid">
                                    <button id="submit-phone-number" type="submit" class="btn btn-grd-deep-blue ">Get
                                        OTP</button>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="d-grid">
                                    <a href="{{ route('member.register_select')}}">Don't have an account?
                                        <span><strong>Register</strong></span></a>
                                </div>
                            </div>

                            <div class="col-12">
                                <div class="d-grid">
                                    <a href="{{ route('member.with_password')}}">forgot bring phone? <span><strong>With
                            ...
                            <div class="col-12">
                                {{-- forgot password --}}
                                <div class="d-grid">
                                    <a href="{{ route('member.forgot_password')}}">forgot password? <span><strong>Forgot
                                                Password</strong></span></a>
                                </div>
                            </div>
                        </form>
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.status == true) {
                        ...
                        $('.alert').html(
                            '<div class="alert alert-danger border-0 bg-grd-danger alert-dismissible fade show"><div class="d-flex align-items-center"><div class="font-35 text-white"><span class="material-icons-outlined fs-2">report_gmailerrorred</span></div><div class="ms-3"><h6 class="mb-0 text-white">' +
                            errorMessage +
                            '</h6></div></div><button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button></div>'
                            );
                    }
                },
