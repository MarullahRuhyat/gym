                ...
                <div class="header-left">
                    <ul class="header-cont">
                        <li><i class="fa fa-phone" aria-hidden="true"></i><a
                                href="https://wa.me/+628170706999">085184741788</a></li>
		...
		<div class="container">
			...
			<div class="row about-row">
				...
				<div class="col-md-7 about-info-cover">
					...
					<ul class="about-cont">
						<li><i class="fa fa-phone" aria-hidden="true"></i><a  href="https://wa.me/+628170706999">085184741788</a></li>
					...
					<div class="contact-item">
						...
						<div class="contact-item-right">
							<ul class="contact-item-list">
								<li><a href="https://wa.me/+628170706999">085184741788</a></li>
							</ul>
						</div>
					</div>
                    <div class="mb-5">
            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-lg-4 footer-item">
                    ...
                    <ul class="footer-cont">
                        <li><i class="fa fa-whatsapp" aria-hidden="true"></i><a href="https://wa.me/+628170706999">085184741788</a>
                        </li>
